...
Route::middleware('auth')->group(function () {
    ...
    // Unsubscribe (User leaves team). Changed URL to avoid conflict with deleteTeam
    Route::delete('/course/{cou_num}/me', [RaceController::class, 'unsubscribeParticipant'])->name('race.unsubscribe');
    
    // Specific Team Unsubscribe (if implemented in AuthController) - Changed URL to avoid conflict
