...
class StoreCourseRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'COU_DUREE.required' => 'La durée est obligatoire.',
            'COU_DUREE.integer' => 'La durée doit être un nombre entier (en minutes).',
            'COU_DUREE.min' => 'La durée doit être d\'au moins 1 minute.',
