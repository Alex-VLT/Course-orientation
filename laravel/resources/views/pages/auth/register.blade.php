        ...
        <div class="w-4/6 max-w-7/10 bg-white rounded-lg shadow-md p-12 mt-10">
                ...
                @csrf <div>
                    ...
                    <div>
                        ...
                        <input type="date" min="{{ date('Y-m-d', strtotime('-120 years')) }}" max="{{ date('Y-m-d') }}" name="naissance" value="{{ old('naissance') }}" class="w-full rounded-md bg-gray-200 border border-gray-200 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-400" required>
                    </div>
